...
impl Tensor {
    ...
    fn add_cpu_inplace(&mut self, other: &Tensor) -> TensorResult<()> {
    ...
    fn add_metal_inplace(&mut self, other: &Tensor) -> TensorResult<()> {
    ...
    fn mul_cpu_inplace(&mut self, other: &Tensor) -> TensorResult<()> {
        use crate::tensor::BufferHandle;
    ...
    fn mul_metal_inplace(&mut self, other: &Tensor) -> TensorResult<()> {
    ...
    pub fn sub_(&mut self, other: &Tensor) -> TensorResult<()> {
        if self.shape().dims() != other.shape().dims() {
            return Err(TensorError::ShapeMismatch {
                expected: self.shape().dims().to_vec(),
                actual: other.shape().dims().to_vec(),
    ...
    fn sub_cpu_inplace(&mut self, other: &Tensor) -> TensorResult<()> {
        use crate::tensor::BufferHandle;
    ...
    fn sub_metal_inplace(&mut self, other: &Tensor) -> TensorResult<()> {
